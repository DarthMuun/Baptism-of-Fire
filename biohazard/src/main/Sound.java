...
public class Sound {
	...
	public Sound() {
		...
		soundURL[0] = getClass().getResource("/sound/A.T.E.Q.A.E.wav");
		...
		soundURL[22] = getClass().getResource("/sound/bloked.wav");
		soundURL[23] = getClass().getResource("/sound/parry.wav");
		soundURL[24] = getClass().getResource("/sound/text.wav");
	}
